...
clusters, while decreasing it will return coarser clustering. Here we use `leiden.community` from the package [leidenAlg](https://github.com/kharchenkolab/leidenAlg):

```{r}
con$findCommunities(method=leidengAlg::leiden.community, resolution=1)
```
