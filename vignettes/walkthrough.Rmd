...
* We will use 'PCA' space here, which is faster than the default 'CPCA' space, and in most cases gives good results. 
* CPCA space should provide more accurate alignment under greater dataset-specific distortions.
* CCA space optimizes conservation of correlation of components between datasets.
