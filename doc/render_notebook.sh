#!/usr/bin/env bash
# Render a conos tutorial .Rmd to .ipynb + .html AND apply the GitHub language_info fixup.
#
...
#
# Usage:  doc/render_notebook.sh conos-walkthrough        (name without extension)
set -euo pipefail
cd "$(dirname "$0")"
