...
A newer and more comprehensive tutorial is available [here](vignettes/Conos_Walkthrough.md)with slightly adjusted [version](https://github.com/hms-dbmi/conos/blob/dev/vignettes/Conos_Walkthrough.md) for Seurat.
